CLASS zcl_abapgit_object_fugr DEFINITION PUBLIC INHERITING FROM zcl_abapgit_objects_program FINAL.
  ...
  PRIVATE SECTION.
    ...
    TYPES: BEGIN OF ty_fugr_names,
      group TYPE rs38l-area,
      program TYPE program,
    END OF ty_fugr_names.
    ...
    METHODS get_names
      RETURNING
        VALUE(rs_names) TYPE ty_fugr_names
      RAISING
...
*       WITH_CLASS_INCLUDES    = ' ' hmm, todo
    ...
    "Detect Namespace for Handling of Generated Maintenance Views
    ...
    IF lines( rt_includes ) > 0.
      ...
      LOOP AT rt_includes ASSIGNING <lv_include>.
        IF <lv_include> CP 'LSVIM*'.
          "Skip auto-generated includes from Table Maintenance Generator
  ...
  METHOD get_names.
    ...
    rs_names-group = lv_group.
    CONCATENATE lv_namespace 'SAPL' lv_group INTO rs_names-program.
...
* Screens: username not stored in D020S database table
  ...
  METHOD zif_abapgit_object~deserialize.
    ...
    lv_program_name = get_names( )-program.
