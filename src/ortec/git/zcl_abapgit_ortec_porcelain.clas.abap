...
CLASS zcl_abapgit_ortec_porcelain IMPLEMENTATION.
  ...
  METHOD pull.
    ...
    DATA ls_batch_manifest LIKE LINE OF lt_batch_manifest.
    ...
    IF lt_remaining_sha1s IS INITIAL.
      walk(
        EXPORTING it_objects      = it_objects
    ...
    ELSE.
      WHILE lt_remaining_sha1s IS NOT INITIAL.
        ...
        lt_batch_objects = zcl_abapgit_ortec_walk_prep=>fetch_blobs_bulk(
          ...
          CHANGING ct_remaining_sha1s = lt_remaining_sha1s ).
  ...
  METHOD walk.
    ...
    DATA lt_blob_batch TYPE zif_abapgit_definitions=>ty_objects_tt.
    DATA lt_batch_sha1s TYPE zif_abapgit_git_definitions=>ty_sha1_tt.
    DATA ls_batch_object TYPE zif_abapgit_definitions=>ty_object.
